...
int main() {
    ...
    printf("**********************************");
    gotoxy(25, 7);
    printf("DEVELOPER-Jithendra Janakantha");
    gotoxy(20, 10);
...
void transfermoney(void) {
    ...
    // Create another file to write amount along with username to which amount is going to be transferred
    fm = fopen("mon.txt", "ab");
...
// Login function to bring user to the login screen
void logout(void) {
    int i, j;
    system("cls");
